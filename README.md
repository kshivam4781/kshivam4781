...
<p align="center">
Full-stack developer & builder — automation, AI tools, and web platforms.<br/>
...
<img src="https://komarev.com/ghpvc/?username=kshivam4781&style=flat&color=6C63FF&label=profile+views" />
</p>
...
- **[ainewswallpaper](https://github.com/kshivam4781/ainewswallpaper)** — turns your Windows desktop into a live dashboard: AI news, trending open-source repos, fresh arXiv papers, markets, weather, and your calendar, redrawn every hour. No API keys, no accounts, runs entirely on your machine.
...
|---|---|---|
| [beetbox/beets](https://github.com/beetbox/beets/pull/6987) | Fixed cached OAuth token files being written world/group-readable | ![PR status](https://img.shields.io/github/pulls/detail/state/beetbox/beets/6987) |
...
| [forthfate/openorbit](https://github.com/forthfate/openorbit/pull/49) | Documented which local-verification commands apply to a docs-only vs. frontend vs. backend vs. UI e2e change | ![PR status](https://img.shields.io/github/pulls/detail/state/forthfate/openorbit/49) |
| [DrVelvetFog/source-review-coverage](https://github.com/DrVelvetFog/source-review-coverage/pull/24) | Found & proved a rename/rename edge case that breaks the merge-replay verifier's octopus-merge equivalence assumption — landed via the maintainer's integration PR [#32](https://github.com/DrVelvetFog/source-review-coverage/pull/32) | ![PR status](https://img.shields.io/github/pulls/detail/state/DrVelvetFog/source-review-coverage/32) |
| [ai-dynamo/dynamo](https://github.com/ai-dynamo/dynamo/pull/14689) | Fixed the Responses API silently dropping reasoning_content unless reasoning.summary was explicitly requested | ![PR status](https://img.shields.io/github/pulls/detail/state/ai-dynamo/dynamo/14689) |
| [vllm-project/semantic-router](https://github.com/vllm-project/semantic-router/pull/3747) | Fixed the Live-verification column reflowing the Pricing column during model checks, with a new Playwright regression test | ![PR status](https://img.shields.io/github/pulls/detail/state/vllm-project/semantic-router/3747) |
| [AcademySoftwareFoundation/MaterialX](https://github.com/AcademySoftwareFoundation/MaterialX/pull/3069) | Fixed two fuzz-found null/out-of-range crashes in MaterialX's 1.38→1.39 version-upgrade path | ![PR status](https://img.shields.io/github/pulls/detail/state/AcademySoftwareFoundation/MaterialX/3069) |
...
<img src="https://img.shields.io/badge/AI_Agents-6C63FF?style=flat" />
...
<p align="center">
<img height="165" src="https://github-readme-stats.vercel.app/api?username=kshivam4781&show_icons=true&theme=tokyonight&hide_border=true&count_private=true" />
<img height="165" src="https://github-readme-stats.vercel.app/api/top-langs/?username=kshivam4781&layout=compact&theme=tokyonight&hide_border=true" />
</p>
<p align="center">
<img src="https://streak-stats.demolab.com/?user=kshivam4781&theme=tokyonight&hide_border=true" />
</p>
...
AI agents & automation · browser-driven workflows · trucking-industry compliance software · finding a good-first-issue worth actually shipping

---

<p align="center"><i>Open to full-stack, AI engineering, and forward-deployed engineering roles — feel free to connect on LinkedIn.</i></p>
